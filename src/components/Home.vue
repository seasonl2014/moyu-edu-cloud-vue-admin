            ...
            <el-dropdown>
                ...
                <el-dropdown-menu slot="dropdown" trigger="click">
                    ...
                    <el-dropdown-item>
                        ...
                        <span type="danger" @click="getContact"><span class="el-icon-ship"></span> &nbsp;更多源码</span>
    ...
    export default {
        ...
        methods: {
            ...
            getContact(){
                ...
                w.location.href = 'http://java.goodym.cn/';
            },
            /**
             加载菜单数据
             */
            async getMenuList() {
                const { data: res } = await this.$http.get("ucenter/user/findMenu");
                if (res.code !== 200)
